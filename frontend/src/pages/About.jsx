const About = () => {
  return (
    <div>
      <h3 className="pb-5 border-b text-2xl">About</h3>
      <p className="py-5 text-sm">
        ...
        like). Contrary to popular belief, Lorem Ipsum is not simply random
        ...
        by H. Rackham. There are many variations of passages of Lorem Ipsum
